...
class CurrentSpotifyPlayback():
    ...
    def get_current_song_artists(self):
        """Returns the current song artists.
        ...
        """
        if self.data:
            return self.data['item']['artists'][0]["name"] # artists return list, take first artist, who is main, and then return their name from the artist object.
        else:
            raise NotPlayingAnywhereException()
